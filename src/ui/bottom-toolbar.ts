...
import pmarkerSvg from './svg/point-marker.svg';
...
class BottomToolbar extends Container {
    constructor(events: Events, tooltips: Tooltips, args = {}) {
        ...
        const pmarker = new Button({
            id: 'bottom-toolbar-pmarker',
            class: 'bottom-toolbar-tool'
        });
        ...
        pmarker.dom.appendChild(createSvg(pmarkerSvg));
        ...
        pmarker.dom.addEventListener('click', () => events.fire('tool.pointMarker'));
        ...
        events.on('tool.activated', (toolName: string) => {
            ...
            pmarker.class[toolName === 'pointMarker' ? 'add' : 'remove']('active');
        ...
        tooltips.register(pmarker, localize('tooltip.pmarker'));
